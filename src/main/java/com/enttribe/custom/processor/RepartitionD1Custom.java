...
import com.enttribe.sparkrunner.processors.dataset.hdfs.RepartitionD1;
import com.enttribe.sparkrunner.util.SparkRunnerUtils;
import com.enttribe.sparkrunner.util.Utils;

public class RepartitionD1Custom extends RepartitionD1 {

    private static final Logger logger = LogManager.getLogger(RepartitionD1Custom.class);

    public RepartitionD1Custom() {
        super();
    }

    public RepartitionD1Custom(Dataset<Row> dataFrame, int processorId, String processorName, String numPartitions, String colNames, String tempTable) {
        super(processorId, processorName, numPartitions, colNames);
        this.dataFrame = dataFrame;
        this.tempTable = tempTable;
    }

    public RepartitionD1Custom(Dataset<Row> dataFrame, int processorId, String processorName, String numPartitions, String tempTable) {
        super(processorId, processorName, numPartitions);
        this.dataFrame = dataFrame;
        this.tempTable = tempTable;
    }
    ...
    public void execute(JobContext jobContext) throws Exception {
        try {
            logger.debug("Fetching declared fields...");
