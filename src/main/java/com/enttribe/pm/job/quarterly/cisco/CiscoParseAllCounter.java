...
public class CiscoParseAllCounter implements
        UDF2<String, scala.collection.immutable.Map<String, scala.collection.immutable.Map<String, String>>, List<Row>>,
        AbstractUDF {

    private static final Logger logger = LoggerFactory.getLogger(CiscoParseAllCounter.class);
    ...
    public CiscoParseAllCounter(JobContext jobContext) {
        this.jobcontext = jobContext;
    }

    public CiscoParseAllCounter() {
    }
    ...
    private void parseAll(List<Row> fileContent,
        ...
        try {
            for (String key : rowDataFinalMap.keySet()) {
                ...
                String measObjLdnForPmemsid = substringAfter(measObjLdn, Symbol.SLASH_FORWARD_STRING);
                if (measObjLdnForPmemsid.contains("LNCEL")) {
    ...
    private void parseAllCounter(List<Row> fileContent, String dateTime, String category, String pmemsId,
        ...
        try {
            ...
            if (allCounterCategoryMap.containsKey(category)) {
                Map<String, Map<String, String>> counterValueMap = getValueMapAllCounters(category, counterValueMap1, measObjLdn);
            ...
            logger.error("Exception Occurred While Parsing Counters With Input Parameters: CATEGORY: {}, PMEMSID: {}, Error: {}",
