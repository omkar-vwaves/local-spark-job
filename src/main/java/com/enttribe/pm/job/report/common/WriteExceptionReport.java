...
public class WriteExceptionReport extends Processor {

    private static final Logger logger = LoggerFactory.getLogger(WriteExceptionReport.class);
    ...
    public WriteExceptionReport() {
        super();
    }

    public WriteExceptionReport(Dataset<Row> dataframe, Integer id, String processorName) {
    ...
    public WriteExceptionReport(Integer id, String processorName) {
        super(id, processorName);
    }
    ...
    public Dataset<Row> executeAndGetResultDataframe(JobContext jobContext) throws Exception {
        ...
        logger.info("=== WriteExceptionReport Execution Started ===");
        ...
        logger.info("=== WriteExceptionReport Execution Completed ===");
