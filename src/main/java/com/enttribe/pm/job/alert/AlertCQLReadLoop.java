...
public class AlertCQLReadLoop extends Processor {

    private static final long serialVersionUID = 1L;
    private static final Logger logger = LoggerFactory.getLogger(AlertCQLReadLoop.class);
    ...
    public AlertCQLReadLoop() {
        super();
        logger.info("AlertCQLReadLoop No Argument Constructor Called!");
    }

    public AlertCQLReadLoop(Dataset<Row> dataframe, Integer id, String processorName) {
        super(id, processorName);
        this.dataFrame = dataframe;
        logger.info("AlertCQLReadLoop Constructor Called with Input DataFrame With ID: {} and Processor Name: {}", id,
                processorName);
    }

    public AlertCQLReadLoop(Integer id, String processorName) {
        super(id, processorName);
        logger.info("AlertCQLReadLoop Constructor Called with ID: {} and Processor Name: {}", id, processorName);
    }
    ...
    public Dataset<Row> executeAndGetResultDataframe(JobContext jobContext) throws Exception {
        ...
        logger.info("[AlertCQLReadLoop] Execution Started!");
        ...
        logger.info("[AlertCQLReadLoop] CURRENT_COUNT={}", CURRENT_COUNT);
        ...
        logger.info("[AlertCQLReadLoop] Input Config Map: {}", inputConfigMap);
        logger.info("[AlertCQLReadLoop] Node And Aggregation Details Map: {}", nodeAndAggregationDetailsMap);
        logger.info("[AlertCQLReadLoop] Extra Parameters Map: {}", extraParametersMap);
        logger.info("[AlertCQLReadLoop] KPI Code Name Map: {}", kpiCodeNameMap);
        ...
        logger.info("++++++[AlertCQLReadLoop] Execution Completed! Time Taken: {} Minutes | {} Seconds", minutes,
                seconds);
