...
public class CloseAlertCQLRead extends Processor {
    ...
    public Dataset<Row> executeAndGetResultDataframe(JobContext jobContext) throws Exception {
        ...
        logger.info("++++++[CloseAlertCQLRead={}] Execution Completed! Time Taken: {} Minutes | {} Seconds",
    ...
    private void initializeGlobalVariables(Map<String, String> jobContextMap, String currentCount) {
        ...
        logger.info(
                "[CloseAlertCQLRead={}] JDBC Credentials: Driver={}, URL={}, User={}, Password={}",
                currentCount,
                sparkPMJdbcDriver,
                sparkPMJdbcUrl,
                sparkPMJdbcUsername,
        ...
        logger.info(
                "[CloseAlertCQLRead={}] Cassandra Credentials: Keyspace={}, Host={}, Port={}, Datacenter={}, Username={}, Password={}",
                currentCount,
