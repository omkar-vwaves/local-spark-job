...
public class OpenAlertLoopMain {

        public static JobContext jobContext = null;

        private static Logger logger = LoggerFactory.getLogger(OpenAlertLoopMain.class);

        public static void main(String[] args) {

                long startTime = System.currentTimeMillis();
                logger.info("🚀 OpenAlertLoopMain Execution Started!");
                ...
                try {
                        ...
                        logger.error("Exception Occurred in OpenAlertLoopMain: {}", e.getMessage());
                        e.printStackTrace();
                }

                long endTime = System.currentTimeMillis();
                long executionTime = endTime - startTime;
                logger.info("🚀 OpenAlertLoopMain Execution Completed in {} Minutes {} Seconds", executionTime / 60000,
