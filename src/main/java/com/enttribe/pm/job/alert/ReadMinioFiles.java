...
public class ReadMinioFiles extends Processor {

    public ReadMinioFiles() {
        super();
    }

    public ReadMinioFiles(Dataset<Row> dataframe, Integer id, String processorName) {
        super(id, processorName);
        this.dataFrame = dataframe;
        logger.info("ReadMinioFiles Constructor Called with ID: {} and Processor Name: {}", id, processorName);
    }

    public ReadMinioFiles(Integer id, String processorName) {
        super(id, processorName);
        logger.info("ReadMinioFiles Constructor Called with ID: {} and Processor Name: {}", id, processorName);
    }
    ...
    public Dataset<Row> executeAndGetResultDataframe(JobContext jobContext) throws Exception {
        ...
        if (this.dataFrame == null || this.dataFrame.isEmpty()) {
            logger.info("Data Frame is Null or Empty!");
        ...
        try {
            ...
            if (trinoOrcDF == null || trinoOrcDF.isEmpty()) {
                ...
                return getEmptyDF(jobContext, counterIds);
            }
            trinoOrcDF.show(5, false);
        ...
        try {
            ...
            logger.info("Trino NE DataFrame Loaded Successfully!");

            // Filter Trino NE DF
            String START_INDEX = jobContext.getParameter("START_INDEX");
            logger.info("ReadMinioFiles START INDEX: {}", START_INDEX);
        ...
        try {
            ...
            joinedResult.show(5, false);
            logger.info("Joined Result DataFrame Created Successfully!");
