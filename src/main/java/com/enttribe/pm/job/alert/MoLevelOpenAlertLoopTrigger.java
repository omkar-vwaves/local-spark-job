...
public class MoLevelOpenAlertLoopTrigger {
    public static JobContext jobContext = null;
    private static Logger logger = LoggerFactory.getLogger(MoLevelOpenAlertLoopTrigger.class);

    public static void main(String[] args) {
        long startTime = System.currentTimeMillis();
        logger.info("MoLevelOpenAlertLoopTrigger Execution Started!");
        ...
        try {
            ...
            String READ_PM_ALERT_CONFIGURATION_QUERY = "SELECT PERFORMANCE_ALERT_ID_PK, CONFIGURATION, EXPRESSION, DOMAIN, VENDOR, NAME, DESCRIPTION, ALERTTYPE, ALERTID,TECHNOLOGY FROM PERFORMANCE_ALERT WHERE DOMAIN = '"
                    ...
                    + frequency + "' AND DELETED = 0 AND PERFORMANCE_ALERT_ID_PK IN (1708,1709)";
            ...
            dataFrame = (new JDBCReadCustom(dataFrame, 1, "READ PM ALERT CONFIGURATION", SPARK_PM_JDBC_DRIVER,
                    SPARK_PM_JDBC_URL, SPARK_PM_JDBC_USERNAME, SPARK_PM_JDBC_PASSWORD,
                    READ_PM_ALERT_CONFIGURATION_QUERY, "PERFORMANCE_ALERT", (String) null, (String) null, (String) null,
            ...
            dataFrame = (new JDBCReadCustom(dataFrame, 2, "READ ACTIVE ALARM LIBRARY", SPARK_FM_JDBC_DRIVER,
                    SPARK_FM_JDBC_URL, SPARK_FM_JDBC_USERNAME, SPARK_FM_JDBC_PASSWORD, READ_ACTIVE_ALARM_LIBRARY_QUERY,
                    "ALARM_LIBRARY", (String) null, (String) null, (String) null, (String) null, (String) null))
            ...
            dataFrame = (new ExecuteSparkSQLD1Custom(dataFrame, 3, "JOIN PERFORMANCE ALERT AND ALARM LIBRARY",
                    JOIN_QUERY, "JOIN_RESULT", (String) null)).executeAndGetResultDataframe(jobContext);
            dataFrame.show(5);
            ...
            for (int i = startIndex; i < endIndex; ++i) {
                ...
                dataFrame = (new ExecuteSparkSQLD1Custom(dataFrame, 10, "COUNTER MAP QUERY", EXECUTE_COUNTER_MAP_QUERY,
                        "finalAggrDataKPI", (String) null)).executeAndGetResultDataframe(jobContext);
                dataFrame.show(5, false);
                ...
                dataFrame = (new ExecuteSparkSQLD1Custom(dataFrame, 11, "KPI EVALUATOR", KPI_EVALUATOR_QUERY,
                        "kpiEvaluatedData", (String) null)).executeAndGetResultDataframe(jobContext);
                ...
                dataFrame = (new ExecuteSparkSQLD1Custom(dataFrame, 13, "GET ONLY BREACHED DATA",
                        "SELECT * FROM cacheKpiEvaluatedData", "cacheKpiEvaluatedDataTemp", (String) null))
                        .executeAndGetResultDataframe(jobContext);
        ...
        logger.info("MoLevelOpenAlertLoopTrigger Execution Completed in {} Minutes {} Seconds",
                executionTime / 60000L, executionTime % 60000L / 1000L);
    ...
    private static SparkConf getSparkConf() {
        return (new SparkConf()).setAppName("MoLevelOpenAlertLoopTrigger").setMaster("local[*]")
