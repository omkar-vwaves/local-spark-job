...
public class OTFAlertBreachedData extends Processor {

    private static final Logger logger = LoggerFactory.getLogger(OTFAlertBreachedData.class);

    public OTFAlertBreachedData() {
        super();
    }

    public OTFAlertBreachedData(Dataset<Row> dataframe, Integer id, String processorName) {
    ...
    public Dataset<Row> executeAndGetResultDataframe(JobContext jobContext) throws Exception {
        ...
        logger.info("OTFAlertBreachedData Execution Started!");
        ...
        logger.info("OTFAlertBreachedData START_INDEX: {}", currentIndex);
        ...
        logger.info("OTFAlertBreachedData Execution Completed!");
