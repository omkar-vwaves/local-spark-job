...
public class OTFCloseAlertMain {
    public static JobContext jobContext = null;
    private static Logger logger = LoggerFactory.getLogger(OTFCloseAlertMain.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = startIndex; i < endIndex; ++i) {
                ...
                dataFrame = (new OTFGenerateCloseAlert(dataFrame, 14,
    ...
    private static SparkConf getSparkConf() {
        return (new SparkConf()).setAppName("OTFCloseAlertMain").setMaster("local[*]")
