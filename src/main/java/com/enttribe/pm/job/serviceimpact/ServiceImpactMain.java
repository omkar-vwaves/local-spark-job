package com.enttribe.pm.job.serviceimpact;
...
public class ServiceImpactMain {

    public static JobContext jobContext = null;

    private static Logger logger = LoggerFactory.getLogger(ServiceImpactMain.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            dataFrame = startProcess(dataFrame, jobContext);
        } catch (Exception e) {
    ...
    private static Dataset<Row> startProcess(Dataset<Row> dataFrame, JobContext jobContext) throws Exception {

        /*
         * READ SERVICE IMPACT RULES
         */

        String READ_SERVICE_IMPACT_RULE_QUERY = "SELECT * FROM SERVICE_IMPACT_DASHBOARD_RULE";
        ...
        dataFrame.show(5);
        logger.info("🚀 READ SERVICE IMPACT RULE Executed Successfully! ✅");
    ...
    private static JobContext setParametersToJobContext(JobContext jobContext) {
        ...
        jobContext.setParameters("RAW_FILE_PATH_SUFFIX", "20250116/0000");
        jobContext.setParameters("PROCESSING_DATE", "250116");
        jobContext.setParameters("PROCESSING_HOUR", "0000");
        jobContext.setParameters("AUDIT_TIME", "2025-01-16 00:00:00");
        jobContext.setParameters("IS_FILE_FILTER_REQUIRED", "true");
        jobContext.setParameters("KPI_ORC_PATH", "s3a://performance/JOB/ORC/QUARTERLY/");
        jobContext.setParameters("DI_ORC_PATH", "s3a://performance/JOB/DI/QUARTERLY/");
